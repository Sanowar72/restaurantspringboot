...
//    UserList.add(new User(1,"sanowar","10 march 1998","sanowar@gmail.com","7903288853",date,time));
    public UserData(){
        String dateString = "2022-05-01T10:30:00"; // Date and time in ISO-8601 format
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss");
        LocalDateTime dateTime = LocalDateTime.parse(dateString, formatter);
        UserList.add(new User(1,"sanowar","10 march 1998","sanowar@gmail.com","7903288853",dateTime));
    }
...
//        LocalDate mydate = LocalDate.parse(userdata.getDate(), DateTimeFormatter.ofPattern("yyyy,MM,dd")); // Parse date string into LocalDate
//        LocalTime mytime = LocalTime.parse(userdata.getTime());
        System.out.println(userdata);
//        LocalDate date = LocalDate.of(2023, 4, 29);
//        LocalTime time = LocalTime.of(10, 30);

//        User newUser = new User(userdata.getId(), userdata.getName(), userdata.getDob(), userdata.getEmail(), userdata.getPhoneno(), date, time);
